...
levels(sample_data(AN_JX_YOR)$Group_Designation)
...
levels(sample_data(AN_UW_YOR)$Group_Designation)
...
levels(AN_JX_n_f_glom_phy_df_YOR$Group_Designation)
...
levels(AN_UW_n_f_glom_phy_df$Group_Designation)
